...
class SwingEquityStrategy(Strategy):
    ...
    def _load_strategies(self) -> List:
        ...
        from strategies.india.equity.swing.swing_trend_pullback import SwingTrendPullbackStrategy
        from strategies.india.equity.swing.swing_momentum_breakout import SwingMomentumBreakoutStrategy
        from strategies.india.equity.swing.swing_mean_reversion import SwingMeanReversionStrategy
        from strategies.india.equity.swing.swing_volatility_squeeze import SwingVolatilitySqueezeStrategy
        from strategies.india.equity.swing.swing_event_driven import SwingEventDrivenStrategy
